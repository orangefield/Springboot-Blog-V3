...
public interface PostRepository extends JpaRepository<Post, Integer> {
    ...
    @Query(value = "INSERT INTO post(categoryId, title, content, userId, thumbnail, createDate, updateDate) VALUES(:categoryId, :title, :content, :userId, :thumnail, now(), now())", nativeQuery = true)
